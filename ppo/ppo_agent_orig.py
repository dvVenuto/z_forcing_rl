...
class PPOAgent(tf_agent.TFAgent):
  ...
  def get_loss(self,
    ...
    print("OBSS INSIEDE LOSS")
    print(time_steps.observation)
    ...
    pri_mu_collector = self._collect_policy_forward.get_pri_mu()
    pri_lv_collector = self._collect_policy_forward.get_log_var()

    print(pri_mu_collector)
    print(pri_lv_collector)
