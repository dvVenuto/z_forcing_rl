...
class RIMCellPlay(tf.keras.layers.Layer):
    ...
    def __init__(self, units, nRIM, k,
        ...
        super(RIMCellPlay, self).__init__()
        self.units = units
        self.nRIM = nRIM
        self.k = k
        ...
        self.implementation =kwargs.pop('implementation', 1)

        self.activation=activations.get("hard_sigmoid")
    ...
    def get_config(self):
        ...
        base_config = super(RIMCellPlay, self).get_config()
