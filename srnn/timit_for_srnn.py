...
def create_test_set(x_lst):
    n = len(x_lst)
    # print(n) # 1680 
    x_lens = np.array(list(map(len, x_lst)))
    print("CREATE_TEST_SET")
    print(x_lens)
    max_len = max(list(map(len, x_lst))) - 1
...
print(os.path.join(timit_folder, 'TRAIN'))
...
print("NUMBER OF TRAIN+VALID FILES:" + str(len(train_files)))
print("NUMBER OF TEST FILES"+ str(len(test_split_files)))
print("TOTAL NUMBER OF SENTENCES"+ str(len(train_files)) + str(len(test_split_files)))
print("NUMBER OF VALID FILES"+ str(num_valid_split_files))
print("NUMBER OF TRAIN FILES"+ str(num_train_split_files))
...
print("train_vector_len after hstack" + str(len(train_vector)))
print("valid_vector_len after hstack" + str(len(valid_vector)))
